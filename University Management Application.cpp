...
public:
    ...
    void displayfte()
    {
        ...
        cout<<r7;
        cout<<endl;
        cout<<"\n\t\t "<<r1<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r4<<"          INDIAN INSTITUTE OF TECHNOLOGY"<<endl;
        cout<<"\t\t "<<r6<<" IIT "<<r6<<"             FACULTY OF ENGINEERING AND TECHNOLOGY,\n";
        cout<<" \t\t "<<r2<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r3<<"                         KANPUR, UTTAR PRADESH.\n";
        cout<<" \t\t                              Accredited with Grade A by KCG,\n";
        cout<<" \t\t                          Education Department, Govt. of Central.\n\n";
        for(int i=0;i<118;i++)
        cout<<r7;
        cout<<endl;
        home();
...
public:
    ...
    void result(string id)
    {
        ...
        for(int i=1;i<66;i++)
            cout<<r5;
            cout<<r4<<endl;
        cout<<"\t"<<r6<<" "<<r1<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r4<<"     INDIAN INSTITUTE OF TECHNOLOGY   "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r6<<" IIT "<<r6<<"        FACULTY OF ENGINEERING AND TECHNOLOGY,      "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r2<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r3<<"                    KANPUR, UTTAR PRADESH.                  "<<r6<<endl;
...
else
{
     ...
     void fee_reciept(string id)
    {
        ...
        cout<<"\t"<<r6<<" "<<r1<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r4<<"     INDIAN INSTITUTE OF TECHNOLOGY   "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r6<<" IIT "<<r6<<"        FACULTY OF ENGINEERING AND TECHNOLOGY,      "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r2<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r3<<"                    KANPUR, UTTER PRADESH.                  "<<r6<<endl;
        cout<<"\t"<<r6<<"                          Accredited with Grade A by KCG,        "<<r6<<endl;
        cout<<"\t"<<r6<<"                      Education Department, Govt. of Gujarat.    "<<r6<<endl;
        cout<<"\t"<<r6<<"                                                                 "<<r6<<endl;
